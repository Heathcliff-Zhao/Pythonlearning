...
hypothesis = "the #### transcript is a written version of each day 's cnn student news program use this transcript to " \
             "he    lp students with reading comprehension and vocabulary use the weekly newsquiz to test your " \
